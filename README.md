...
Télécharger le fichier? IDK quoi mettre
...
###1
Comprenre un bout de code qui m'avais été transmis pour mieux comprendre sont fonctionnement afin de l'adapté à mon objectif. 
...
###3
Dans le sens inverse, lorsque j'avais une hypothèse sur un bout de mon code que je pensais être possible de simplifié. Demandé à un LLM s'y mon hypothèse était viable afin de ne pas la testé dans le vide. 
