...
function init(){
    scene('psy2', () => {
        ...
        loquace.script([
            ...
            "p Explique-moi ce qui t'arrive.",
            ...
            "p Tout n'est pas obligé d'être positif tu sais?",
            "j ...C'est vrai..., j'ai l'impression que j'ai changé.",
            "p Comment cela?",
            "j Bah... mes copains disent que je fais moins de blagues.", //10
            "j J'avais toujours pleins d'histoires, des musiques, qui arrivaient dans ma tête.",
            "j J'en ai plus, ma tête est plus calme, mais cela me manque.",
            "p C'est une des conséquances du médicament, cela calme le trouble.",
            "p Le TDAH est aussi le moteur de plein de choses positives !",
            "j A l'école, cela m'arrive d'être 'trop' concentré.", //15
            "j Des fois, j'ai mal à la tête et j'ai l'impression d'étouffer un peu...",
            "p Cela veut dire que le traitement n'est pas adapté, on va le changer.",    
            ...
            "j Oui, c'est vrai. Pendant les week-ends et les vacances,",
            ...
            "j Ils savent maintenant, que je fais pas exprès.", //25
            "fin"
        ]);
    });
};